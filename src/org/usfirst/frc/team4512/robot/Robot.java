...
public class Robot extends IterativeRobot {
	...
	*/
    ...
    final double autoSpeedLeft = autoSpeedRight * 1.1;
	...
	public void teleopPeriodic() {
    	...
    	*/
    	...
    	//Collector Controls
    	//REEEEft and Right are imverted you dingus
    	...
    	//Hook Controls
    	//USE DIFFERENT CONSTANTS FOR THE HOOK AND THE CLIMBER >:
    	//GO DOWN AT 0.7 SPEED & GO UP AT WARP FACTOR 9
    	...
    	//Climber Controls (AKA the Winch)
    	...
    	if (joystickRight.getRawButton(2)) {
    		if (Math.abs(joystickRightTwist) >= 0.05) {
